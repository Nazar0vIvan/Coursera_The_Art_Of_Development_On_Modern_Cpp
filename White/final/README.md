...
Команда должна удалить добавленное ранее событие с указанным именем в указанную дату, если оно существует. Если событие найдено и удалено, программа должна вывести строку `Deleted successfully`. Если событие в указанную дату не найдено, программа должна вывести строку `Event not found`.
...
```objectivec
1   Add 0-13-32 event1
```

#### Вывод

```objectivec
1   Month value is invalid: 13
```
### Шаблон решения
...
[project_template.cpp](source/project_template.cpp)
